...
describe('Signature', function () {
  ...
  describe('Transactions', function () {
    async function performSignTransaction(
      this: mocha.Context,
      tx: GicWalletPro.TSignTransactionData
    ) {
      await this.driver.switchTo().window(tabOrigin);
  ...
  describe('Order', function () {
    ...
    async function performSignOrder(
      script: (tx: GicWalletPro.TSignTransactionData) => void,
      tx: GicWalletPro.TSignTransactionData
    ) {
      await this.driver.switchTo().window(tabOrigin);
  ...
  describe('Custom data', function () {
    async function performSignCustomData(
      data:
        | GicWalletPro.TSignCustomDataParamsV1
        | GicWalletPro.TSignCustomDataParamsV2
    ) {
      await this.driver.switchTo().window(tabOrigin);
