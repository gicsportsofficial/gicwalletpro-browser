...
const baseByNetwork = {
  mainnet: 'https://futfinance.com',
  testnet: 'https://testnet.futfinance.com',
};
      ...
      try {
        ...
        switch (errMessage) {
          ...
          case 'Incorrect username or password.':
            ...
            break;
          case 'You have exceeded incorrect username or password limit. If you have any problems, please contact support https://support.futfinance.com/.':
