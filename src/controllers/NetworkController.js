...
export class NetworkController {
  constructor({ localStore, getNetworkConfig, getNetworks }) {
    const defaults = {
      ...
      customNodes: {
        mainnet: DEFAULT_CONFIG.NETWORK_CONFIG.mainnet.server,
        stagenet: DEFAULT_CONFIG.NETWORK_CONFIG.stagenet.server,
        testnet: DEFAULT_CONFIG.NETWORK_CONFIG.testnet.server,
        custom: DEFAULT_CONFIG.NETWORK_CONFIG.custom.server,
      },
      customMatchers: {
        mainnet: DEFAULT_CONFIG.NETWORK_CONFIG.mainnet.matcher,
        testnet: DEFAULT_CONFIG.NETWORK_CONFIG.testnet.matcher,
        stagenet: DEFAULT_CONFIG.NETWORK_CONFIG.stagenet.matcher,
        custom: DEFAULT_CONFIG.NETWORK_CONFIG.custom.matcher,
      },
      customCodes: {
        mainnet:  DEFAULT_CONFIG.NETWORK_CONFIG.mainnet.code,
        testnet: DEFAULT_CONFIG.NETWORK_CONFIG.testnet.code,
        stagenet: DEFAULT_CONFIG.NETWORK_CONFIG.stagenet.code,
        custom: DEFAULT_CONFIG.NETWORK_CONFIG.custom.code,
      },
    };
